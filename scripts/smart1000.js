...
export async function main(ns) {
    ...
    const targets = [
        "lexo-corp", "global-pharm", "zb-institute", "snap-fitness", "zb-def", "solaris", "unitalife", 
        "applied-energetics", "zeus-med", "nova-med", "univ-energy", "titan-labs", "microdyne", "galactic-cyber", 
        "defcomm", "aerocorp", "icarus", "infocomm", "vitalife", "deltaone", "helios", "omnia", 
        "stormtech", "omnitek", "taiyang-digital", "kuai-gong"
    ];
